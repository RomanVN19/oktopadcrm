...
var Receipt = /*#__PURE__*/function (_Entity) {
  _inherits(Receipt, _Entity);
  ...
  function Receipt(params) {
    ...
    _this.structure = _structure.structures.Receipt;
    return _this;
  ...
  _createClass(Receipt, [{
    ...
    value: function makeRecords(doc) {
      ...
      records.ProductRecord = products.filter(function (item) {
...
_defineProperty(Receipt, "doc", true);

_defineProperty(Receipt, "records", ['ProductRecord', 'DebtRecord']);