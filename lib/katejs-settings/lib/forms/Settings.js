...
function (_Form) {
  ...
  function Settings(args) {
    ...
    _defineProperty(_assertThisInitialized(_this), "apply", function () {
      _this.app.Settings.set(_this.getValues());
    });

    _this.elements = [];

    _this.app.settingsParams.fields.forEach(function (item) {
      return _this.elements.push((0, _client.getElement)(item, _assertThisInitialized(_this)));
    });
...
_defineProperty(Settings, "title", 'Settings');