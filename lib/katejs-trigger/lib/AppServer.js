...
var _Trigger = _interopRequireDefault(require("./entities/Trigger"));

var _TriggerMixin = _interopRequireDefault(require("./entities/TriggerMixin"));
  ...
  return /*#__PURE__*/function (_use) {
    ...
    function Server(params) {
      ...
      _this.entities = _objectSpread(_objectSpread({}, _this.entities), {}, {
        Trigger: (0, _Trigger.default)(_this.entities.Trigger)
      });
      return _this;
    }
    ...
    _createClass(Server, [{
      ...
      value: function afterInit() {
        if (_get(_getPrototypeOf(Server.prototype), "afterInit", this)) {
          _get(_getPrototypeOf(Server.prototype), "afterInit", this).call(this);
        }
      ...
      value: function beforeInit() {
        ...
        Object.keys(this.entities).forEach(function (name) {
          _this2.entities[name] = (0, _TriggerMixin.default)(_this2.entities[name]);
          _this2.entities[name].entity = name;
        });
      }
    }]);
