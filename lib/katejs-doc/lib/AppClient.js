...
var _DocItem = _interopRequireDefault(require("./forms/DocItem"));

var _DocList = _interopRequireDefault(require("./forms/DocList"));
      ...
      _createClass(Client, [{
        ...
        value: function afterInit() {
          ...
          Object.keys(this.forms).forEach(function (formName) {
            if (formName.endsWith('Item') && _this2.forms[formName].doc) {
              _this2.forms[formName] = (0, _DocItem.default)(_this2.forms[formName]);
            }

            if (formName.endsWith('List') && _this2.forms[formName].doc) {
              _this2.forms[formName] = (0, _DocList.default)(_this2.forms[formName]);
            }
          });
        }
      }]);
