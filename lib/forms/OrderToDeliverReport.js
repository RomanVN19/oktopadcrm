...
function (_Form) {
  ...
  function OrderReport(args) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(OrderReport).call(this, args));
    ...
    regeneratorRuntime.mark(function _callee() {
      var _this$getValues, date, showNegative, _ref2, response, clients, _ref3, debts;
