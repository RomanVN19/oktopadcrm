...
var ProductsFlowReport = /*#__PURE__*/function (_Form) {
  _inherits(ProductsFlowReport, _Form);

  var _super = _createSuper(ProductsFlowReport);

  function ProductsFlowReport(args) {
    var _this;

    _classCallCheck(this, ProductsFlowReport);
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 4;
              return Promise.all([_this.app.ProductRecord.balance({
                date: (0, _moment.default)(startDate).startOf('day')
              }), _this.app.ProductRecord.turnover({
                where: {
                  date: {
    ...
    _this.elements = [{
      ...
      columns: [{
        ...
        format: function format(val) {
          return val.docTitle || val.product && val.product.title || 'None';
        }
      }, {
        title: 'Start',
        dataPath: 'start'
  ...
  return ProductsFlowReport;
}(_client.Form);

exports.default = ProductsFlowReport;

_defineProperty(ProductsFlowReport, "title", 'Product flow');

_defineProperty(ProductsFlowReport, "entity", 'Order');