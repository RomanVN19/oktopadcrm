...
var ClientSelection = /*#__PURE__*/function () {
  function ClientSelection(_ref) {
    ...
    _defineProperty(this, "search", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
      var where, _yield$_this$app$Clie, clients;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 6:
              ...
              clients = _yield$_this$app$Clie.response;
    ...
    _defineProperty(this, "create", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
      var body;
    ...
    _defineProperty(this, "clientQuery", /*#__PURE__*/function () {
      var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(query) {
        var _yield$_this$app$Clie2, response;
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                _yield$_this$app$Clie2 = _context3.sent;
                response = _yield$_this$app$Clie2.response;
                return _context3.abrupt("return", (response || []).map(function (item) {
                  return _objectSpread(_objectSpread({}, item), {}, {
                    title: "".concat(item.title, " (").concat(item.phone || '').concat(item.phone && item.address ? ',' : '').concat(item.address || '', ")")
                  });
                }));
    ...
    if (replaceSelect) {
      this.elements.set('client', {
        ...
        elements: [_objectSpread(_objectSpread({}, clientInput), {}, {
          cols: 6,
