...
function _templateObject7() {
  var data = _taggedTemplateLiteral(["Spreaded ", " to order ", ""]);
...
function _templateObject6() {
  var data = _taggedTemplateLiteral(["Rest sum ", ""]);
...
function _templateObject3() {
  var data = _taggedTemplateLiteral(["No sum!"]);
...
function _templateObject2() {
  var data = _taggedTemplateLiteral(["Doing spread..."]);
...
function _templateObject() {
  var data = _taggedTemplateLiteral(["Spread payment from ", ""]);
...
function () {
  function SpreadPayment(_ref) {
    ...
    _defineProperty(this, "open", function (client) {
      _this.content.spreadPaymentModal.title = _this.app.t(_templateObject(), client.title);
      _this.content.spreadPaymentModal.open = true;
      _this.client = client;
    });

    _defineProperty(this, "spread",
    /*#__PURE__*/
    _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee() {
      var sum, _ref3, orders, index, sumToPay;

      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _this.log(_this.app.t(_templateObject2()), true);

              sum = _this.content.spreadPaymentSum.value;
              _this.content.spreadPaymentSum.value = 0;

              if (!sum) {
                _this.log(_this.app.t(_templateObject3()));
              }
            ...
            case 9:
              ...
              if (sumToPay > sum) {
                ...
                _this.log(_this.app.t(_templateObject4(), sum, (0, _moment.default)(orders[index].date).format('DD.MM.YYYY')));
                ...
                _this.log(_this.app.t(_templateObject5(), sumToPay, (0, _moment.default)(orders[index].date).format('DD.MM.YYYY')));
              }

              if (index === orders.length - 1 && sum > 0) {
                _this.log(_this.app.t(_templateObject6(), sum));

                orders[index].payed += sum;

                _this.log(_this.app.t(_templateObject7(), sum, (0, _moment.default)(orders[index].date).format('DD.MM.YYYY')));
