...
var ClientDebt = /*#__PURE__*/function () {
  ...
  _createClass(ClientDebt, [{
    ...
    value: function () {
      var _exec = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(clientUuid) {
        var _yield$this$app$DebtR, data, totals;
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                _yield$this$app$DebtR = _context2.sent;
                data = _yield$this$app$DebtR.response;
                ...
                this.content.clientDebtTitle.title = this.app.t(_templateObject || (_templateObject = _taggedTemplateLiteral(["Clients debt ", ": ", ""])), this.report ? '' : this.content.client.value.title, totals[2]);
