...
var _WhatsNew = _interopRequireDefault(require("./forms/WhatsNew"));
  ...
  return (
    ...
    function (_use) {
      ...
      function Client(args) {
        ...
        _this.forms.WhatsNew = _WhatsNew.default;

        _this.menu.push({
          form: 'WhatsNew',
          icon: _icons.default.WhatsNew,
          title: 'What\'s new'
        });

        _this.docsAccessFilter = function () {
          return true;
        };
